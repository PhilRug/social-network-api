...
// Function to generate random comments that we can add to the database. Includes comment responses.
const getRandomComments = (int) => {
  ...
  for (let i = 0; i < int; i++) {
    results.push({
      ...
      responses: [...getCommentResponses(3)],
    });
  }
  return results;
};
...
module.exports = { getRandomName, getRandomComments, getRandomComments };
